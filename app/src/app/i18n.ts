...
const resources = {
  da: {
    translation: {
      ...
      Time: "Tid",
      Sequences: "Sekvenser",
      "Suspected source": "Mistænkt kilde",
      "Human sequences": "Menneske sekvenser",
      "Human": "Menneske",
      "Food": "Mad",
      "Food sequences": "Mad sekvenser",
      "All sequences": "Alle sekvenser",
      "New sequences (1 week)": "Nye sekvenser (1 uge)",
      "Latest sample date": "Seneste sample dato",
