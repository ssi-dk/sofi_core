...
type IndexableOf<T extends NotEmpty> = keyof Pick<T, { [K in keyof T]: T[K] extends string | number ? K : never }[keyof T]>;
 ...
 */
export function arrayToNormalizedHashmap<T extends NotEmpty, K extends IndexableOf<T>>(array: T[], keyField: K) {
