...
/**
 */
function createUserViewRaw<T>(
  requestParameters: CreateUserViewRequest,
  requestConfig: runtime.TypedQueryConfig<T, void> = {}
): QueryConfig<T> {
  let queryParameters = null;
  ...
  const config: QueryConfig<T> = {
    ...
    body:
      queryParameters ||
      UserDefinedViewToJSON(requestParameters.userDefinedView),
  };
...
/**
 */
export function createUserView<T>(
  requestParameters: CreateUserViewRequest,
  requestConfig?: runtime.TypedQueryConfig<T, void>
): QueryConfig<T> {
 ...
 */
function deleteViewRaw<T>(
  requestParameters: DeleteViewRequest,
  requestConfig: runtime.TypedQueryConfig<T, void> = {}
): QueryConfig<T> {
  if (requestParameters.name === null || requestParameters.name === undefined) {
    throw new runtime.RequiredError(
      "name",
      "Required parameter requestParameters.name was null or undefined when calling deleteView."
    );
  }
 ...
 */
function getUserByNameRaw<T>(
  requestParameters: GetUserByNameRequest,
  requestConfig: runtime.TypedQueryConfig<T, User> = {}
): QueryConfig<T> {
  if (
    requestParameters.username === null ||
    requestParameters.username === undefined
  ...
  if (requestTransform) {
    config.transform = (body: ResponseBody, text: ResponseBody) =>
      requestTransform(UserFromJSON(body), text);
  }
 ...
 * Get user by user name
 */
export function getUserByName<T>(
  requestParameters: GetUserByNameRequest,
  requestConfig?: runtime.TypedQueryConfig<T, User>
): QueryConfig<T> {
...
/**
 */
function getUserViewsRaw<T>(
  requestConfig: runtime.TypedQueryConfig<T, Array<UserDefinedView>> = {}
): QueryConfig<T> {
  let queryParameters = null;
  ...
  if (requestTransform) {
    config.transform = (body: ResponseBody, text: ResponseBody) =>
      requestTransform(body.map(UserDefinedViewFromJSON), text);
  }
...
/**
 */
export function getUserViews<T>(
  requestConfig?: runtime.TypedQueryConfig<T, Array<UserDefinedView>>
): QueryConfig<T> {
