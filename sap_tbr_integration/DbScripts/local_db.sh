docker run -e 'ACCEPT_EULA=Y' -e 'SA_PASSWORD=MyStrongPassword123' --mount src="$(pwd)",target=/scripts,type=bind,readonly --network sap_default --name sdb -p 1433:1433 -d mcr.microsoft.com/mssql/server:2017-latest
sleep 30
