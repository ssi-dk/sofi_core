...
openssl req -x509 -passin pass:test -new -nodes -key $ca_key -sha256 -days 10240 -out $ca_pem -subj "/C=DK/ST=Copenhagen/L=Copenhagen/O=Delegate/CN=sofi_tbr_integration_dev"
