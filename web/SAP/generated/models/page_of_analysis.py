...
from web.SAP.generated.models.analysis import Analysis
import re
from .. import util

from web.SAP.generated.models.analysis import Analysis  # noqa: E501
import re  # noqa: E501
...
class PageOfAnalysis(Model):
    ...
    def paging_token(self, paging_token):
        ...
        if paging_token is not None and not re.search(r'^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$', paging_token):  # noqa: E501
            raise ValueError("Invalid value for `paging_token`, must be a follow pattern or equal to `/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/`")  # noqa: E501
