...
import web.src.services.lims.openapi.models
from web.src.services.lims.openapi import rest
from web.src.services.lims.openapi.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(web.src.services.lims.openapi.models, klass)
