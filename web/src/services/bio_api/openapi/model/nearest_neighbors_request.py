...
class NearestNeighborsRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, seq_collection, filtering, profile_field_path, input_mongo_id, cutoff, unknowns_are_diffs, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, seq_collection, filtering, profile_field_path, input_mongo_id, cutoff, unknowns_are_diffs, *args, **kwargs):  # noqa: E501
        """NearestNeighborsRequest - a model defined in OpenAPI
