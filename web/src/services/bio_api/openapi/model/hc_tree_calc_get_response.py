...
class HCTreeCalcGETResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, job_id, created_at, status, finished_at, dmx_job, method, result, *args, **kwargs):  # noqa: E501
        """HCTreeCalcGETResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, job_id, created_at, status, finished_at, dmx_job, method, result, *args, **kwargs):  # noqa: E501
        """HCTreeCalcGETResponse - a model defined in OpenAPI
