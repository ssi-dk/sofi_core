...
class NearestNeighborsGETResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, job_id, created_at, status, finished_at, seq_collection, filtering, profile_field_path, input_mongo_id, cutoff, unknowns_are_diffs, result, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, job_id, created_at, status, finished_at, seq_collection, filtering, profile_field_path, input_mongo_id, cutoff, unknowns_are_diffs, result, *args, **kwargs):  # noqa: E501
        """NearestNeighborsGETResponse - a model defined in OpenAPI
