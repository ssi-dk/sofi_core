...
class NearestNeighborsRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["seq_collection", "filtering", "profile_field_path", "input_mongo_id", "cutoff", "unknowns_are_diffs"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NearestNeighborsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NearestNeighborsRequest from a dict"""
        if obj is None:
            return None
