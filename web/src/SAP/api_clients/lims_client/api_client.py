...
from api_clients.lims_client import rest
from api_clients.lims_client.configuration import Configuration
from api_clients.lims_client.exceptions import ApiTypeError, ApiValueError, ApiException
from api_clients.lims_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ConnectionsApi()
        api_instance.delete_connections  # this is an instance of the class Endpoint
        api_instance.delete_connections()  # this invokes api_instance.delete_connections.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.delete_connections.callable or self.callable in this class
