...
class Analysis(Model):
    ...
    def isolate_id(self, isolate_id):
        ...
        if isolate_id is None:
            raise ValueError(
                "Invalid value for `isolate_id`, must not be `None`"
            )  # noqa: E501
        if isolate_id is not None and not re.search(
            r"^\d{4}_\d{2}_[A-Z0-9]{3}$", isolate_id
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `isolate_id`, must be a follow pattern or equal to `/^\d{4}_\d{2}_[A-Z0-9]{3}$/`"
            )  # noqa: E501
    ...
    def test_timestamp(self, test_timestamp):
        ...
        if test_timestamp is None:
            raise ValueError(
                "Invalid value for `test_timestamp`, must not be `None`"
            )  # noqa: E501
    ...
    def date_received(self, date_received):
        ...
        if date_received is None:
            raise ValueError(
                "Invalid value for `date_received`, must not be `None`"
            )  # noqa: E501
    ...
    def resfinder_version(self, resfinder_version):
        ...
        :type resfinder_version: str
        """
        if resfinder_version is not None and not re.search(
            r"^\d*\.\d*$", resfinder_version
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `resfinder_version`, must be a follow pattern or equal to `/^\d*\.\d*$/`"
            )  # noqa: E501
    ...
    def serum_type(self, serum_type):
        ...
        :type serum_type: str
        """
        if serum_type is not None and not re.search(
            r"^[A-Z]{8}$", serum_type
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `serum_type`, must be a follow pattern or equal to `/^[A-Z]{8}$/`"
            )  # noqa: E501
    ...
    def agent(self, agent):
        ...
        if agent not in allowed_values:
            raise ValueError(
                "Invalid value for `agent` ({0}), must be one of {1}".format(
                    agent, allowed_values
                )
            )
    ...
    def species(self, species):
        ...
        if species not in allowed_values:
            raise ValueError(
                "Invalid value for `species` ({0}), must be one of {1}".format(
                    species, allowed_values
                )
            )
    ...
    def organization(self, organization):
        ...
        if organization not in allowed_values:
            raise ValueError(
                "Invalid value for `organization` ({0}), must be one of {1}".format(
                    organization, allowed_values
                )
            )
