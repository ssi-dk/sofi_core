...
class TbrMetadata(Model):
    ...
    def __init__(self, id=None, sequence_id=None, sequence_filename=None, isolate_id=None, institution=None, project_number=None, project_title=None, date_sample=None, date_received=None, date_sofi=None, run_id=None, full_runid=None, public_number=None, primary_isolate=None, cpr_nr=None, gender=None, name=None, age=None, travel=None, travel_country=None, date_run=None, date_received_kma=None, kma=None, region=None, fud_number=None, cluster_id=None, date_epi=None):  # noqa: E501
        ...
        :type run_id: str
        :param full_runid: The full_runid of this TbrMetadata.  # noqa: E501
        :type full_runid: str
    ...
    @property
    def id(self):
        """Gets the id of this TbrMetadata.


        :return: The id of this TbrMetadata.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this TbrMetadata.


        :param id: The id of this TbrMetadata.
        :type id: str
        """
        if id is None:
    ...
    @property
    def full_runid(self):
        """Gets the full_runid of this TbrMetadata.


        :return: The full_runid of this TbrMetadata.
        :rtype: str
        """
    ...
    def full_runid(self, full_runid):
        """Sets the full_runid of this TbrMetadata.


        :param full_runid: The full_runid of this TbrMetadata.
        :type full_runid: str
        """
