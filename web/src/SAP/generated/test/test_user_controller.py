...
class TestUserController(BaseTestCase):
    ...
    def test_create_user_view(self):
        ...
        user_defined_view = {"columns": ["columns", "columns"], "name": "name"}
        headers = {
    ...
    def test_get_user_views(self):
        ...
        response = self.client.open("/api/user/views", method="GET", headers=headers)
        self.assert200(response, "Response body is : " + response.data.decode("utf-8"))
    ...
    def test_login_user(self):
        ...
        response = self.client.open(
            "/api/user/login", method="GET", headers=headers, query_string=query_string
        )
        self.assert200(response, "Response body is : " + response.data.decode("utf-8"))
    ...
    def test_logout_user(self):
        ...
        """
        headers = {}
        response = self.client.open("/api/user/logout", method="GET", headers=headers)
        self.assert200(response, "Response body is : " + response.data.decode("utf-8"))
